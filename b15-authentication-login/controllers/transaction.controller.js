...
module.exports.index = (req, res) => {
  ...
  var transaction = db.get('transactions').find({idUser: cookieUser, isComplete: false}).value();
  ...
  if (user.isAdmin === true) {
    ...
    res.render("transactions/index", {transactions: transaction, users: user, books: books});
  }
};
